...
public class BudgetActivity extends AppCompatActivity {
    //Cheia catre API
    private static final String CLOUD_VISION_API_KEY = "AIzaSyALe3LfPpJKeHHH9ryUjYGzZfdv_hkOlBE";
    ...
    //Extrage imaginea de la camera
    public File getCameraFile() {
        File dir = getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        return new File(dir, FILE_NAME);
    }
    //Uploadeaza imaginea catre server
    @Override
    ...
    //Ia rezultatele de la CloudVision
